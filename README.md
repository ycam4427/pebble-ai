...
<p>
  <a href="https://github.com/YOUR_USERNAME/Pebble/releases/latest"><b>⬇&nbsp; Download for Windows</b></a>
  &nbsp;•&nbsp;
  <a href="https://YOUR_USERNAME.github.io/Pebble/"><b>🌐&nbsp; Website</b></a>
  &nbsp;•&nbsp;
...
1. **Install [Ollama](https://ollama.com)** and pull a model:
   ...
   ```
2. **Download Pebble** from the [latest release](https://github.com/YOUR_USERNAME/Pebble/releases/latest) and run **`Pebble_0.9.0_x64-setup.exe`** *(or grab the portable `Pebble.exe`)*.
...
<a href="https://star-history.com/#YOUR_USERNAME/Pebble&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=YOUR_USERNAME/Pebble&type=Date&theme=dark" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=YOUR_USERNAME/Pebble&type=Date" />
  </picture>
</a>
